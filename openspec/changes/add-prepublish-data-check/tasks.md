...
- [x] 1.1 Measure every planned production edit, including the validator and documentation; stop for approval before implementation if the change would exceed three production files or 120 changed production lines.
- [x] 1.2 Confirm the receipt is a regular non-symlink file outside the canonical repository root and is excluded from Git, the public bundle, and static output.
