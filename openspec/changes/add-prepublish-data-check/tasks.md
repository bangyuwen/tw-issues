...
- [ ] 2.1 Add the dependency-free Node validator that reads base/HEAD Git blobs, rejects public-path worktree drift, and validates exact receipt bindings, evidence boundaries, dispositions, and outcomes.
...
- [ ] 3.2 Add focused tests for omitted or duplicate scope, revision/data/worktree drift, move target paths, invalid outcomes, every forbidden receipt boundary, no network calls, and no worktree mutation.
