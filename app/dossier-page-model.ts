...
const approvedHsinchuProsecutorClaims: readonly HsinchuClaimSnapshot[] = [
  {
    ...
    harmRisk: "elevated",
    proofScope: "只確認第三方公開之具印文處分書影像第 9–11 頁，可見檢察官如此說明工程預算、服務費、契約變更與政府採購法判斷。",
    limitations: [
      "這是可見處分書頁面的檢方理由，不是法院判決。",
      "各筆金額仍須以契約變更、補助核銷及最終結算文件逐筆核對。",
      "第三方公開附件僅涵蓋第 3–22 頁，且有遮蔽；不能據此補寫缺頁、還原被遮蔽內容或視為官方完整處分書。",
    ],
    sourceRefs: ["source-58"],
  },
  {
    statement: "檢方表示，通訊監察、金流比對、搜索及帳務分析未發現林智堅或市府人員與巨佳、艾奕康間有不法金流、收賄或圖利事證；審計及市府調查所列角色混淆、採購督導不周及驗收不妥，屬行政疏失，尚無積極證據證明刑責。",
    claimType: "attributed_statement",
    harmRisk: "high",
    proofScope: "只確認第三方公開之具印文處分書影像第 10–11 頁，可見檢察官如此說明通訊監察、金流、搜索、帳務與行政疏失／刑事證據區分。",
    limitations: [
  ...
  },
  {
    ...
    claimType: "attributed_statement",
    harmRisk: "high",
    proofScope: "只確認第三方公開之具印文處分書影像第 15–17 頁，可見檢察官如此說明B5類土石方回填規範、縮時影像與證人證述。",
    limitations: [
  ...
  },
  {
    ...
    claimType: "attributed_statement",
    harmRisk: "elevated",
    proofScope: "只確認第三方公開之具印文處分書影像第 16–17 頁，可見檢察官如此說明草皮植床材料、檢查紀錄、土層厚度與成本。",
    limitations: [
  ...
  },
  {
    ...
    claimType: "attributed_statement",
    harmRisk: "high",
    proofScope: "只確認第三方公開之具印文處分書影像第 18–20 頁，可見檢察官如此說明PE網、噴灌管線、電線、石塊比例、不合格物數量及未見故意非法掩埋的判斷。",
    limitations: [
